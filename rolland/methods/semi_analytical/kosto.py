...
class TBCont1LKosto(AnalyticalMethodsKosto):
    r"""Timoshenko beam on continuous 1-layer foundation.

    Based on the method according to :cite:p:`kostovasilis_semi-analytical_2017`.
...
class TBCont2LKosto(AnalyticalMethodsKosto):
    r"""Timoshenko beam on continuous 2-layer foundation.

    Based on the method according to :cite:p:`kostovasilis_analytical_2017`.
