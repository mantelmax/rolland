...
autosummary_filename_map = {
    ...
    "rolland.database.rail.db_rail.available_rails": "available_rails",
    "rolland.database.rail.db_rail.load_rail": "load_rail",
    "rolland.database.rail.db_rail.load_rail_geo": "load_rail_geo",
    "rolland.database.rail.db_rail.load_rail_warping": "load_rail_warping",
